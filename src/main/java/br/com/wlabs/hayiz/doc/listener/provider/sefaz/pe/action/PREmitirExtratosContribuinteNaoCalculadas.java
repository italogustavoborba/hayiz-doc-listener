...
public class PREmitirExtratosContribuinteNaoCalculadas extends SefazPernambucoProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(PREmitirExtratosContribuinteNaoCalculadas.class);
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    ...
                    String key = data.get("workspaceCode").toString() + "/document/" +
                            ...
                            LocalDate.now().format(DateTimeFormatter.ofPattern("yyMM")) + "/extratos-contribuinte-nao-calculadas-" +
                            UUID.randomUUID() + ".pdf";

                    Request request = new Request.Builder()
                            .url("https://efiscoi.sefaz.pe.gov.br/sfi_trb_cmt/PREmitirExtratosContribuinte")
                    ...
                    formData.put("evento", "emitirRelatorioExtratoNaoCalculadas");
                    formData.put("DtPeriodoFiscal", LocalDate.now().plusMonths(-1).format(DateTimeFormatter.ofPattern("MM/yyyy")));
                    ...
                    Element tipoTelaMensagemUsuario = doc.selectFirst("input[name=cd_tipo_tela_mensagem_usuario]");
                    if(tipoTelaMensagemUsuario != null && tipoTelaMensagemUsuario.hasAttr("value")) {
                        if(tipoTelaMensagemUsuario.attr("value").equals("3")) {
                            fixCSS(doc);
