...
public class AvisosImportantesTomador extends CaruaruPernambucoProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(AvisosImportantesTomador.class);
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    ...
                    String key = data.get("workspaceCode").toString() + "/document/" +
                            ...
                            LocalDate.now().format(DateTimeFormatter.ofPattern("yyMM")) + "/avisos-importantes-tomador-" +
                            UUID.randomUUID() + ".pdf";
                    ...
                    String status = "DONE";
                    List<Integer> ids = Arrays.asList(1, 2, 6, 7, 8, 9, 11, 13, 16, 17, 19, 20);
                    for (int id: ids) {
                        request = new Request.Builder()
