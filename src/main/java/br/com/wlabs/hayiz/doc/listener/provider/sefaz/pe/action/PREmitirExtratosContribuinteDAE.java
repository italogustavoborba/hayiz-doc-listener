...
public class PREmitirExtratosContribuinteDAE extends SefazPernambucoProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(PREmitirExtratosContribuinteDAE.class);
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    ...
                    String key = data.get("workspaceCode").toString() + "/document/" +
                            ...
                            LocalDate.now().format(DateTimeFormatter.ofPattern("yyMM")) + "/extratos-contribuinte-dae-" +
                            UUID.randomUUID() + ".pdf";
                    ...
                    formData.put("evento", "emitirRelatorioExtratoDebitos");
                    ...
                    formData.put("evento", "emitirExtratoDebitos");
                    ...
                    formData = HTMLUtil.formElementToMap((FormElement) doc.selectFirst("form[name=frm_principal]"));
                    formData.put("evento", "emitirRelatorioDebitos");
