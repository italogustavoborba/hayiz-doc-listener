package br.com.wlabs.hayiz.doc.listener.provider.city.pe.bomjardim;
...
public class ExtratoDebitoBomJardim extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoBomJardim.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.BOM_JARDIM, document, keyEntry);
