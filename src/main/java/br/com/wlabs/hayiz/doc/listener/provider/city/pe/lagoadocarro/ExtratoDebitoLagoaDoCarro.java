package br.com.wlabs.hayiz.doc.listener.provider.city.pe.lagoadocarro;
...
public class ExtratoDebitoLagoaDoCarro extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoLagoaDoCarro.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.LAGOA_DO_CARRO, document, keyEntry);
