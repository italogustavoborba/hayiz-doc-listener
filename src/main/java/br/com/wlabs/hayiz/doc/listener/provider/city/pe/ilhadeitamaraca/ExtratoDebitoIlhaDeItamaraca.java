package br.com.wlabs.hayiz.doc.listener.provider.city.pe.ilhadeitamaraca;
...
public class ExtratoDebitoIlhaDeItamaraca extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoIlhaDeItamaraca.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.ILHA_DE_ITAMARACA, document, keyEntry);
