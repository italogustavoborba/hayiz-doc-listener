package br.com.wlabs.hayiz.doc.listener.provider.city.pe.orobo;
...
public class ExtratoDebitoOrobo extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoOrobo.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.OROBO, document, keyEntry);
