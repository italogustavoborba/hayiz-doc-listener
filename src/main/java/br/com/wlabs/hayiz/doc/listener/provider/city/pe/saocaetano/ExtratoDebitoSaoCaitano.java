package br.com.wlabs.hayiz.doc.listener.provider.city.pe.saocaetano;
...
public class ExtratoDebitoSaoCaitano extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoSaoCaitano.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.SAO_CAETANO, document, keyEntry);
