package br.com.wlabs.hayiz.doc.listener.provider.city.pe.saolourenco;
...
public class ExtratoDebitoSaoLourenco extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoSaoLourenco.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.SAO_LOURENCO, document, keyEntry);
