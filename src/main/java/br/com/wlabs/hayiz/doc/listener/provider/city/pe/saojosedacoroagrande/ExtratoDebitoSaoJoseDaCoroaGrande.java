package br.com.wlabs.hayiz.doc.listener.provider.city.pe.saojosedacoroagrande;
...
public class ExtratoDebitoSaoJoseDaCoroaGrande extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoSaoJoseDaCoroaGrande.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.SAO_JOSE_DA_COROA_GRANDE, document, keyEntry);
