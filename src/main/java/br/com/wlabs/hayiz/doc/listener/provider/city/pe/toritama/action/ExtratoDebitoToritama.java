package br.com.wlabs.hayiz.doc.listener.provider.city.pe.toritama.action;
...
public class ExtratoDebitoToritama extends ToritamaPernambucoProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoToritama.class);
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    ...
                    Request request = new Request.Builder()
                            .url("https://gestor.tributosmunicipais.com.br/redesim/prefeitura/toritama/views/publico/portaldocontribuinte/")
                            .method("GET", null)
                            .build();
                    ...
                    if(Objects.nonNull(loginMsg) && loginMsg.hasText()) {
                        Document cdata = Jsoup.parse(loginMsg.text(), "https://gestor.tributosmunicipais.com.br");
