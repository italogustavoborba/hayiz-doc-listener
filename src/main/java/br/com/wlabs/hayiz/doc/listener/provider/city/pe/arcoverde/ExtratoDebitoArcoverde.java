package br.com.wlabs.hayiz.doc.listener.provider.city.pe.arcoverde;
...
public class ExtratoDebitoArcoverde extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoArcoverde.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.ARCOVERDE, document, keyEntry);
