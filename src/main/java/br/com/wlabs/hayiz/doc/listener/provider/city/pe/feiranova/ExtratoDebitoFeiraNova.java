package br.com.wlabs.hayiz.doc.listener.provider.city.pe.feiranova;
...
public class ExtratoDebitoFeiraNova extends TributosMunicipaisProvider implements SQSAction {

    private Logger log = LoggerFactory.getLogger(ExtratoDebitoFeiraNova.class);
    ...
    public void process(Message message, String queueUrl, final String receiptHandle, String messageGroupId,
        ...
        try {
            ...
            for(Map<String, Object> document: documents) {
                ...
                try {
                    stopWatch.start();
                    this.extratoDebito(message, CONTEXT.FEIRA_NOVA, document, keyEntry);
